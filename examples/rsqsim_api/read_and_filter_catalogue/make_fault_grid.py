...
# out_tri_globalobj = "Jordan_tri_global.obj"
# meshio.write(out_tri_global1, mesh_tri_global1, file_format="vtk", binary=False)
# meshio.write(out_tri_globalobj, mesh_tri_global1, file_format="obj")
#
...
# out_tri_local3 = "White_Island_North_2_tri_local.obj"
# meshio.write(out_tri_local3, mesh_tri_local3, file_format="obj")
#
...
# Read in CFF (Hannu's examples)
fault4 = tsurf(cff_tsurf)
points4 = fault4.mesh.points
triangles4 = [("triangle", fault4.mesh.cells_dict['triangle'])]

mesh_tri_global4 = meshio.Mesh(points4, triangles4)
out_tri_global4 = "CFF_2.obj"
meshio.write(out_tri_global4, mesh_tri_global4, file_format="obj")

fault4 = tsurf(cff_resample_tsurf)
points4 = fault4.mesh.points
triangles4 = [("triangle", fault4.mesh.cells_dict['triangle'])]
mesh_tri_global4 = meshio.Mesh(points4, triangles4)
out_tri_global4 = "CFF2_resampled.stl"
meshio.write(out_tri_global4, mesh_tri_global4, file_format="stl")
